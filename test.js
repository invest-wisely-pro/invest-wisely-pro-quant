...
function suitePensione() {
  ...
  if (global.calcPensione) {
    ...
    if (r) {
      ...
      // Con un capitale ETF importante, l'ETF mensile delle barre dev'essere sostanziale e
      // coerente col 4% SWR del capitale, indipendentemente da quanto INPS+FP già coprono.
      try {
        ...
        if (r2 && Array.isArray(r2.decData) && r2.decData.length) {
          ...
          // l'ETF del primo anno dev'essere vicino al SWR pieno (entro 15%), non ~0
          ...
          // e dev'essere coerente con etfPrelievoMens della barra-riepilogo in alto
